						...
						<div class="col-lg-8 left-contents">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            <div class="jq-tab-menu">
	                                ...
	                                <!--<div class="jq-tab-title" data-tab="4"></div>
	                                <div class="jq-tab-title" data-tab="5"></div>-->
	                            </div>
	                                ...
	                                <div class="jq-tab-content" data-tab="3">
										<ul class="course-list">
											<li class="justify-content-between d-flex">
												...
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/python/default.asp">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>Full Stack Web Development</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/whatis/whatis_fullstack.asp">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>Java Programming</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/java/">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>Mongo DB</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/mongodb/">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>Cloud Computing</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/aws/aws_cloudessentials_cloudcomputing.php">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>Cyber Security</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/cybersecurity/">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>Mobile App Development</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/appml/">View Details</a>
											</li>																		
											<li class="justify-content-between d-flex">
												<p>Kotlin Programming</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/KOTLIN/index.php">View Details</a>
											</li>
											<li class="justify-content-between d-flex">
												<p>ios Developer</p>
												<a class="primary-btn text-uppercase" href="https://www.w3schools.com/w3css/w3css_color_ios.asp">View Details</a>
											</li>
							...
							<ul>
								<li>
									<a class="justify-content-between d-flex" href="#">
										<p>Graduation Type</p> 
										<span class="or">Master Degree</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex" href="#">
										<p>Course Fee </p>
										<span>Rs.15,000 (per semester)</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex" href="#">
								...
								<li>
									<a class="justify-content-between d-flex" href="#">
										<p>Class Time </p>
										<span>9.15 am to 4.00 pm</span>
									</a>
								</li>
							</ul>
							<a href="http://www.udayaschoolofengineering.com/admission.php" class="primary-btn text-uppercase">Enroll the course</a>
						</div>
					</div>
				</div>	
			</section>
